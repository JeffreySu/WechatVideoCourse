...
namespace SenparcClass.Controllers
{
    ...
    {
        public static readonly string Token = WebConfigurationManager.AppSettings["WxOpenWeixinToken"];//与微信公众账号后台的Token设置保持一致，区分大小写。
        ...
        public static readonly string AppId = SenparcClass.Service.Config.WxOpenAppId;//与微信小程序账号后台的AppId设置保持一致，区分大小写。
        public static readonly string AppSecret = SenparcClass.Service.Config.WxOpenAppSecret;//与微信小程序账号后台的AppId设置保持一致，区分大小写。
